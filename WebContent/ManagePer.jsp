...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Select Nurse in charge</h1>
                    ...
                    <table class="table table-hover">
                    	...
                    	<td>
                    		<select class="form-control" name="nurse">
                                ...
                                String sqlText4 ="SELECT n.name, s.name_id from schedule_nurse s ,nurse n WHERE s.name_id=n.username AND s.duration= 2 AND s.day=4";
