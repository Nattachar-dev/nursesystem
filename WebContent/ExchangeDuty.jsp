...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Exchange Duty</h1>
            
          </div>
    	
      <!-- Main Content -->
      	 
      <form id=from action="<%=request.getContextPath()%>/ExchangeDutyServlet" method="get"> 	

                    <table class="table table-hover">
                    
                    
                    	<tr>
                    	<td><div class="text-xs font-weight-bold text-info text-uppercase mb-1">1.Name-Surname</div></td>
                    	<td  >
                    		<input type="text" class="form-control bg-light border-0 small" placeholder="..." aria-label="Search" aria-describedby="basic-addon2" name=nurse id=nurse>
                    	</td>   
                    	</tr>
        
                    	<tr>
                    	<td><div class="text-xs font-weight-bold text-primary text-uppercase mb-1">2.Date-Duration(Yours)</div></td>
                    	...
                    	<tr>
                    	<td><div class="text-xs font-weight-bold text-success text-uppercase mb-1">3.Date-Duration Exchange</div></td>
                    	<td>
                    			
                    			<div class="form-group"> <!-- Date input -->
						        <input class="form-control bg-light border-0 small" id="date2" name="date" placeholder="MM/DD/YYY" type="text"/>
						      	</div>
                    	...
                    	<tr>
                    	<td><div class="text-xs font-weight-bold text-warning text-uppercase mb-1">4.With </div></td>
                    	<td>
                    		<select class="form-control" name="nurse">
                                ...
                                String sqlText4 ="SELECT s.name_id ,n.name FROM schedule_nurse s ,nurse n WHERE duration=1 AND day = 15 AND s.name_id = n.username";
                                Statement statement4 = connection2.createStatement();
                                ResultSet rs4= statement4.executeQuery(sqlText4);
                                while(rs4.next()){
                                    %>
                                    <option value ='<%=rs4.getString("n.name")%>'><%=rs4.getString("n.name")%></option>
